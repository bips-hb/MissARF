...
# Plots for results sim_logreg_coverage_m_40.R - Simulation on more multiple imputation m=40 for 0.4 missingness
#comparing m=20 and m=40
...
ggsave("supplement_plots/plot_multiple_40.pdf", plot = bb, width = 210, height = 260, units = "mm", scale = 1.5) 
