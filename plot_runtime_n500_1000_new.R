...
#thread = 16  
p0 <- plot_fct(filter = "sing_500_", ts = 1e9, title="a) Single imputation, n=500, 16 threads")
p1 <- plot_fct(filter = "sing_1000_", ts = 1e9, title="c) Single imputation, n=1000, 16 threads")
p2<-plot_fct(filter = "sing_10000_", ts = 1e9, x_labs="Time (sec)", title="e) Single imputation, n=10000, 16 threads")
#plot_fct(filter = "multi_10000_", ts = 1e9, x_labs="Time (s)", title="Runtime of mutliple imputation and n=10000 with 16 threads.")
p3<-plot_fct(filter = "multi_500_", ts = 1e9, x_labs="Time (sec)", title="b) Mutliple imputation, n=500, 16 threads")
p4<-plot_fct(filter = "multi_1000_", ts = 1e9, x_labs="Time (sec)", title="d) Mutliple imputation, n=1000, 16 threads")
p5<-plot_fct(filter = "multi_10000_", ts = 1e9, x_labs="Time (sec)", title="f) Mutliple imputation, n=10000, 16 threads")
#plot_fct(filter = "multi_10000_", ts = 6e10, x_labs="Time (min)", title="Mutliple imputation, n=10000, 16 threads")

bb <- (p0 | p3) / (p1 | p4) / (p2 | p5) 
#thread=16
ggsave("supplement_plots/runtime_thread16_sec.pdf", plot = bb, width = 210, height = 260, units = "mm", scale = 1.5) 

##thread=1
runtime_k1 <- readRDS("microbenchmark_results_k1.rds")
runtime <- runtime_k1

p0 <-plot_fct(filter = "sing_500_", ts = 1e9, x_labs="Time (sec)", title="a) Single imputation, n=500, 1 thread", k = "k1")
p1 <-plot_fct(filter = "sing_1000_", ts = 1e9, x_labs="Time (sec)", title="c) Single imputation, n=1000, 1 thread", k = "k1")
p2<-plot_fct(filter = "sing_10000_", ts = 1e9, x_labs="Time (sec)", title="e) Single imputation, n=10000, 1 thread", k = "k1")
##plot_fct(filter = "multi_10000_", ts = 1e9, x_labs="Time (s)", title="Runtime of mutliple imputation and n=10000 with 1 threads.", k = "k1")
p3<-plot_fct(filter = "multi_500_", ts = 1e9, x_labs="Time (sec)", title="b) Mutliple imputation, n=500, 1 thread", k = "k1")
p4<-plot_fct(filter = "multi_1000_", ts = 1e9, x_labs="Time (sec)", title="d) Mutliple imputation, n=1000, 1 thread", k = "k1")
p5<-plot_fct(filter = "multi_10000_", ts = 1e9, x_labs="Time (sec)", title="f) Mutliple imputation, n=10000, 1 thread", k = "k1")
#p5<-plot_fct(filter = "multi_10000_", ts = 6e10, x_labs="Time (min)", title="d) Mutliple imputation, n=10000, 1 thread", k = "k1")

bb <- (p0 | p3) / (p1 | p4) / (p2 | p5) 
#thread=1
#ggsave("supplement_plots/runtime_thread1.pdf", plot = bb, width = 210, height = 173.33, units = "mm", scale = 1.5) 
#thread=16
ggsave("supplement_plots/runtime_thread1_sec.pdf", plot = bb, width = 210, height = 260, units = "mm", scale = 1.5) 
