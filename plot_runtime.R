...
p3<-plot_fct(filter = "multi_1000_", ts = 1e9, x_labs="Time (sec)", title="Mutliple imputation, n=1000, 16 threads")
p4<-plot_fct(filter = "multi_10000_", ts = 6e10, x_labs="Time (min)", title="Mutliple imputation, n=10000, 16 threads")
...
#thread=16
ggsave("supplement_plots/runtime_thread16.pdf", plot = bb, width = 210, height = 173.33, units = "mm", scale = 1.5) 
